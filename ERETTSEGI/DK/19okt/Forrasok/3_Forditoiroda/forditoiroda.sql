CREATE DATABASE forditoiroda 
DEFAULT CHARACTER SET utf8
COLLATE utf8_hungarian_ci;
 use forditoiroda;create table doku(id int(11)  ,terjedelem int(11)  ,szakterulet varchar(100)  ,nyelvid int(11)  ,munkaido int(11)  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
 ALTER TABLE doku ADD INDEX(nyelvid);
ALTER TABLE doku ADD PRIMARY KEY(id);
 INSERT INTO doku VALUES
( 1,111932,"jog",3,8),
...
create table fordito(nyelvid int(11)  ,szemelyid int(11)  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
 
ALTER TABLE fordito ADD PRIMARY KEY(nyelvid,szemelyid);
 INSERT INTO fordito VALUES
( 1,1),
( 18,1),
( 50,1),
( 67,1),
...
( 133,76),
( 144,76);
create table nyelv(id int(11)  ,fnyelv varchar(100)  ,cnyelv varchar(100)  ,egysegar int(11)  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
 ALTER TABLE nyelv ADD INDEX(fnyelv);ALTER TABLE nyelv ADD INDEX(cnyelv);
ALTER TABLE nyelv ADD PRIMARY KEY(id);
...
create table szemely(id int(11)  ,nev varchar(100)  ,elerheto boolean  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
( 75,"Nagy Tímea",0),
( 76,"Tanács Lilla",1);
ALTER TABLE `fordito` ADD CONSTRAINT `fordito_81`   FOREIGN KEY (`szemelyid`)     REFERENCES `szemely` (`id`);ALTER TABLE `doku` ADD CONSTRAINT `doku_91`   FOREIGN KEY (`nyelvid`)     REFERENCES `nyelv` (`id`);ALTER TABLE `fordito` ADD CONSTRAINT `fordito_101`   FOREIGN KEY (`nyelvid`)     REFERENCES `nyelv` (`id`);
