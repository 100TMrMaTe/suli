...
drop DATABASE if EXISTS szinkronhangok;
...
INSERT INTO `film` (`id`, `cim`, `eredeti`, `ev`, `rendezo`, `magyarszoveg`, `szinkronrendezo`, `studio`) VALUES
...
INSERT INTO `szinkron` (`szinkid`, `id`, `szerep`, `szinesz`, `hang`) VALUES
...
--
ALTER TABLE `szinkron`
  ADD CONSTRAINT `szinkfilm` FOREIGN KEY (`id`) REFERENCES `film` (`id`)  on delete set null;
COMMIT;
