...
ALTER TABLE film ADD COLUMN IF NOT EXISTS  rendezo_id INT NOT NULL AFTER rendezo;
ALTER TABLE film ADD COLUMN IF NOT EXISTS magyarszoveg_id INT NOT NULL AFTER magyarszoveg;
ALTER TABLE film ADD COLUMN IF NOT EXISTS szinkronrendezo_id INT NOT NULL AFTER szinkronrendezo;
ALTER TABLE szinkron ADD COLUMN IF NOT EXISTS szinesz_id INT NOT NULL AFTER szinesz;
ALTER TABLE szinkron ADD COLUMN IF NOT EXISTS hang_id INT NOT NULL AFTER hang;
...
ALTER TABLE film
ADD CONSTRAINT rendezo_fk
FOREIGN KEY (rendezo_id) REFERENCES ember(id);

ALTER TABLE film
ADD CONSTRAINT magyarszoveg_fk
FOREIGN KEY (magyarszoveg_id) REFERENCES ember(id);

ALTER TABLE film
ADD CONSTRAINT szinkronrendezo_fk
FOREIGN KEY (szinkronrendezo_id) REFERENCES ember(id);


ALTER TABLE szinkron
ADD CONSTRAINT szinesz_fk
FOREIGN KEY (szinesz_id) REFERENCES ember(id);

ALTER TABLE szinkron
ADD CONSTRAINT hang_fk
FOREIGN KEY (hang_id) REFERENCES ember(id);




ALTER TABLE film
ADD CONSTRAINT studio_fk
